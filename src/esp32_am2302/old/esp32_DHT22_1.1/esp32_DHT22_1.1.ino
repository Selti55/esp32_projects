...
#include <RemoteXY.h> // include after connection settings !!!

// RemoteXY GUI configuration  
#pragma pack(push, 1)  
uint8_t RemoteXY_CONF[] =   // 114 bytes
  { 255,0,0,8,0,107,0,19,0,0,0,69,83,80,51,50,95,68,72,84,
  50,50,0,31,1,106,200,1,1,6,0,129,5,17,72,12,64,17,84,104,
  ...
  17,78,38,26,3,67,8,85,52,17,78,2,26,3,129,60,30,16,15,64,
  1,194,176,67,0,129,60,86,11,15,64,17,37,0 };
